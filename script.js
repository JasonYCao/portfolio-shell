const version = "JasonShell [Version 0.0.0.2]";
const directory = "C:\\users\\guest";
const asciiArt = "░░░░░██╗░█████╗░░██████╗░█████╗░███╗░░██╗  ░█████╗░░█████╗░░█████╗░\n░░░░░██║██╔══██╗██╔════╝██╔══██╗████╗░██║  ██╔══██╗██╔══██╗██╔══██╗\n░░░░░██║███████║╚█████╗░██║░░██║██╔██╗██║  ██║░░╚═╝███████║██║░░██║\n██╗░░██║██╔══██║░╚═══██╗██║░░██║██║╚████║  ██║░░██╗██╔══██║██║░░██║\n╚█████╔╝██║░░██║██████╔╝╚█████╔╝██║░╚███║  ╚█████╔╝██║░░██║╚█████╔╝\n░╚════╝░╚═╝░░╚═╝╚═════╝░░╚════╝░╚═╝░░╚══╝  ░╚════╝░╚═╝░░╚═╝░╚════╝░\n                                             "

const intro = "Hi, I'm Jason Cao! Welcome to JasonShell, my portfolio website. I am a full-stack software engineer with a broad range of knowledge in this area!. I'm passionate about AI/ML, graphical engines, and all kinds of software tools. If you want to see my resume, type 'resume'.\n\nType 'help' or 'h' to see what other commands are available. Have fun exploring this site!";
var prevCommands = [];
var commandPlace = -1;

const projects = {
    ETFDB: {
        description: "My first project at my first co-op, it was a full stack application that focused on ETFs and providing smart financial data for investors. There were algorithms and predicted data systems that truly empowered investors on the platform. To this day, it still gets millions of visitors every month!",
        stack: [
            "Ruby on Rails",
            "Javascript",
            "MySQL",
...
const commands = {
    contact: () => {
        window.open("mailto:jason.cao1225@gmail.com", "_blank").focus();
    },
    intro: () => {
        print(intro);
    },
    ...
    resume: () => {
        window.open("Jason_Cao_Resume.pdf", "_blank").focus();
    ...
    instagram : () => {
        window.open("https://www.instagram.com/thecowknight", "_blank").focus();
    },
    linkedin : () => {
        window.open("https://www.linkedin.com/in/jason-cao-1a8b94149", "_blank").focus();
    },
	help: () => {
